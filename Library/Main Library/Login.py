...
def welcome_user():
    ...
    print(Fore.CYAN + Style.BRIGHT + f"||" + Fore.GREEN + Style.BRIGHT + f"{t1:^93}" + Fore.CYAN + Style.BRIGHT + f" ||")
    print(Fore.CYAN + Style.BRIGHT + f"|| {t5} ||")
    print(Fore.CYAN + Style.BRIGHT + f"||" +  Fore.GREEN + Style.BRIGHT + f"{t2:^94}" + Fore.CYAN + Style.BRIGHT + f"  ||")
    print(Fore.CYAN + Style.BRIGHT + f"|| {t5} ||")
    print(Fore.CYAN + Style.BRIGHT + f"||" + Fore.GREEN + Style.BRIGHT + f"  {t3:^95}" + Fore.CYAN + Style.BRIGHT + f" ||")
    print(Fore.CYAN + Style.BRIGHT + f"|| {t5} ||")
    print(Fore.CYAN + Style.BRIGHT + f"{t4}")
